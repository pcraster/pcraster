...
extern int AppRgetRowCol(const MAP *m, /* map handle */
...
extern int AppRgetCoords(const MAP *m, /* map handle */
...
extern void AppPutVal(MAP *outputFile,   /* map to write */
...
/* readcols.c */
extern int AppReadColumnFile(REAL8 ***recs,
                             size_t *nrRecs,
