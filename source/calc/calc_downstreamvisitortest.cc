...
BOOST_AUTO_TEST_CASE(realistic_ldd)
{
  ...
  {
    UINT1 mask1[] = {MV_UINT1, 2,        2,        MV_UINT1, 1, 5,        4,       4,
                     4,        MV_UINT1, MV_UINT1, 6,        9, MV_UINT1, MV_UINT1};
    fieldapi::TestField<UINT1, 3, 5> mask2(mask1);
    fieldapi::ReadWriteData<UINT1, UINT1> mask(TEST_FIELD_INIT(mask2));
    mask.putAllMV();

    UINT1 d1[] = {MV_UINT1, 2, 2, MV_UINT1, 1, 5, 4, 4, 4, MV_UINT1, MV_UINT1, 6, 9, MV_UINT1, MV_UINT1};
    fieldapi::TestField<UINT1, 3, 5> d2(d1);
    fieldapi::ReadOnlySpatial<UINT1, UINT1> const f(TEST_FIELD_INIT(d2));
...
BOOST_AUTO_TEST_CASE(known_order)
{
  ...
  }
  {
    UINT1 d1[] = {MV_UINT1, MV_UINT1, MV_UINT1, MV_UINT1, MV_UINT1, MV_UINT1, 5,       4,
                  4,        MV_UINT1, MV_UINT1, MV_UINT1, MV_UINT1, MV_UINT1, MV_UINT1};
    fieldapi::TestField<UINT1, 3, 5> d2(d1);
    fieldapi::ReadOnlySpatial<UINT1, UINT1> const f(TEST_FIELD_INIT(d2));
  ...
  }
  {
    UINT1 d1[] = {MV_UINT1, MV_UINT1, MV_UINT1, MV_UINT1, MV_UINT1, MV_UINT1, 6,       6,
                  5,        MV_UINT1, MV_UINT1, MV_UINT1, MV_UINT1, MV_UINT1, MV_UINT1};
    fieldapi::TestField<UINT1, 3, 5> d2(d1);
    fieldapi::ReadOnlySpatial<UINT1, UINT1> const f(TEST_FIELD_INIT(d2));
...
BOOST_AUTO_TEST_CASE(all_directions)
{
  ...
  }
  {
    UINT1 d1[] = {MV_UINT1, MV_UINT1, MV_UINT1, MV_UINT1, MV_UINT1, MV_UINT1, 3,        2, 1,
                  MV_UINT1, MV_UINT1, 6,        5,        4,        MV_UINT1, MV_UINT1, 9, 8,
                  7,        MV_UINT1, MV_UINT1, MV_UINT1, MV_UINT1, MV_UINT1, MV_UINT1};
