...
//! suite
boost::unit_test::test_suite*calc::KinematicTest::suite()
{
  boost::unit_test::test_suite* suite = BOOST_TEST_SUITE(__FILE__);
  boost::shared_ptr<KinematicTest> instance(new KinematicTest());

  suite->add(BOOST_CLASS_TEST_CASE(&KinematicTest::iterate1, instance));
  suite->add(BOOST_CLASS_TEST_CASE(&KinematicTest::iterate2, instance));
...
//! ctor
calc::KinematicTest::KinematicTest()
{
}
...
void calc::KinematicTest::iterate1()
{
...
void calc::KinematicTest::iterate2()
{
 // does not terminate
 double v = IterateToQnew(
              /* Qin */ 0,
