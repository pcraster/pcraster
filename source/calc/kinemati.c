 ...
 */
static void Sum(int r, /* row current cell */
                int c, /* column current cell */
                MAP_REAL8 *Qnew, const MAP_REAL8 *Qold, const MAP_REAL8 *q,
...
int Kinematic(MAP_REAL8 *Qnew,                             /* -w discharge at time j+1 */
              const MAP_UINT1 *ldd, const MAP_REAL8 *Qold, /* discharge at time j   */
              const MAP_REAL8 *q,                          /* overland water that flows in channel*/
              const MAP_REAL8 *alpha,                      /* see kinematic wave formula */
              const MAP_REAL8 *beta, const MAP_REAL8 *deltaT, const MAP_REAL8 *deltaX)
{
