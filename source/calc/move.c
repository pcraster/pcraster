...
int Move(MAP_UINT1 *result,                       /* Read-write output map  */
         const MAP_UINT1 *in, const MAP_REAL8 *x, /* Digital Elevation Model */
...
static INT4 getShift(const MAP_REAL8 *m)
{
    REAL8 r = NAN;
    m->Get(&r, 0, 0, m);
...
int Shift(MAP_REAL8 *result,                       /* Read-write output map  */
          const MAP_REAL8 *in, const MAP_REAL8 *y, /* Integer Northing */
...
int Shift0(MAP_REAL8 *result,                       /* Read-write output map  */
           const MAP_REAL8 *in, const MAP_REAL8 *y, /* Integer Northing */
           const MAP_REAL8 *x)                      /* Integer Easting */
{
    INT4 xColVal = 0;
