 ...
 */
static REAL8 CalcSpreadValue(INT4 *id,                  /* write-only id */
 ...
 */
static int PerformSpread(MAP_REAL8 *outCost,        /* read-write output costs */
 ...
 */
int SpreadMax(MAP_REAL8 *outCost,        /* read-write output map  */
              ...
              const MAP_REAL8 *maxCost)  /* maximum cost before cell is read */
{
    ...
    REAL8 costVal = NAN, s = NAN, f = NAN;    /* s = initial cost, f = friction of cell */
