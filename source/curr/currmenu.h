...
extern CURR_SELECT_BOX *
CurrNewItemsInBox(CURR_RADIO_SELECT_BOX *b, const char **items, int nrItems);

extern CURR_RADIO_SELECT_BOX *CurrInitRadioSelectBox(int beginY,
                                                     int beginX,
                                                     int nrRulesVis,
                                                     int nrColsVis,
                                                     const char **items,
...
extern CURR_MULTI_SELECT_BOX *CurrInitMultiSelectBox(int beginY,
                                                     int beginX,
                                                     int nrRules,
                                                     int nrCols,
                                                     const char **items,
...
extern int CurrMultiSelectItem(int itemOrKey, CURR_MULTI_SELECT_BOX *mBox);
