...
extern POINT2D *IntersectCords(POINT2D *i,
                               const POINT2D *l1p1,
                               const POINT2D *l1p2,
                               const POINT2D *l2p1,
                               const POINT2D *l2p2);
extern POINT2D *
IntersectLineCord(POINT2D *i, const LINE *l, const POINT2D *c1, const POINT2D *c2);
extern int PointOnLineAlsoOnCord(const POINT2D *p, const POINT2D *c1, const POINT2D *c2);
extern POINT2D *PerpOnCord(POINT2D *cut,
                           LINE *perp,
                           const POINT2D *p,
                           const POINT2D *c1,
                           const POINT2D *c2);
extern int
MiddleOnLine(const LINE *l, const POINT2D *p1, const POINT2D *p2, const POINT2D *p3);
...
extern int
IntersectAllignedRectangles(POINT2D *pol, const POINT2D *r1, const POINT2D *r2);
