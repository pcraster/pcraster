...
mldd::VertexIterator::VertexIterator() : d_g(nullptr), d_v()
{
}

mldd::VertexIterator::VertexIterator(const DagRaster &g, Vertex v) : d_g(&g), d_v(v)
{
}

//! Copy constructor.
mldd::VertexIterator::VertexIterator(VertexIterator const &rhs) : d_g(rhs.d_g), d_v(rhs.d_v)
{
}
