...
C9------RETURN.
     ...
     1 SC2,TRPY,IN,ISS,NCOL,NROW,NLAY,IOUT,WETDRY,IWDFLG,CVWD,HNOFLO)
C
...
C3------PREPARE AND CHECK BCF DATA.
     ...
     1         ISS,NCOL,NROW,NLAY,IOUT,WETDRY,IWDFLG,CVWD,HNOFLO)
C
C4------RETURN
      RETURN
      END
...
C10-----RETURN.
     ...
     1    DELC,ISS,NCOL,NROW,NLAY,IOUT,WETDRY,IWDFLG,CVWD,HNOFLO)
C
