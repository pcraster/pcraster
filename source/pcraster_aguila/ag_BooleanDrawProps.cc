...
*/
ag::BooleanDrawProps::BooleanDrawProps(const std::string &title, const com::RawPalette *p,
...
*/
const com_ClassClassifier<UINT1> &ag::BooleanDrawProps::classifier() const
{
  assert(_classifier);
  return *_classifier;
}
