...
ag::GeneralDataPropertiesWidget::GeneralDataPropertiesWidget(DataObject &dataObject,
                                                             const DataGuide &dataGuide, QWidget *parent)

    : ag::PropertiesWidget("General data properties", dataObject, dataGuide, parent),
...
void ag::GeneralDataPropertiesWidget::createInterface()
{
  ...
  d_data->d_show->setToolTip("Select whether the data should be visualised");
}
