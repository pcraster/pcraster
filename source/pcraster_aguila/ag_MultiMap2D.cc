...
MultiMap2D::MultiMap2D(DataObject *dataObject, size_t nrRows, size_t nrCols, QWidget *parent)
...
void MultiMap2D::createInterface(size_t nrRows, size_t nrCols)
{
...
void MultiMap2D::addAttribute(size_t row, size_t col, DataGuide const &guide)
{
  d_legendView->addAttribute(guide);
...
void MultiMap2D::saveAsPNG(std::filesystem::path const & /* path */) const
{
