...
NominalRasterDrawer::NominalRasterDrawer(Raster const *raster, dal::SpaceDimensions const &dimensions,
...
void NominalRasterDrawer::draw(QPainter &painter, QRect const &indices,
