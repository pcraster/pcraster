...
PreferencesDialog::PreferencesDialog(DataObject *dataObject, QWidget *parent, bool modal,
                                     Qt::WindowFlags flags)

    : QDialog(parent, flags), d_dataObject(dataObject),
...

{
  ...
  connect(d_ui.d_okButton, SIGNAL(clicked()), this, SLOT(accept()));
  connect(d_ui.d_applyButton, SIGNAL(clicked()), this, SLOT(apply()));

  d_ui.d_preferencesTab->removeTab(
      d_ui.d_preferencesTab->indexOf(d_ui.d_preferencesTab->currentWidget()));
