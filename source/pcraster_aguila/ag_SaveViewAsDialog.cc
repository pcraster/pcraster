...
SaveViewAsDialog::SaveViewAsDialog(std::string const &applicationName, dal::DataSpace const &space,
    ...
    : QDialog(parent, flags), d_applicationName(applicationName), d_formats(formats), d_space(space),
      d_address(address)
