...
template <>
std::vector<ag::DataObjectBase<ag::Table>::Tuple> ag::DataObjectBase<ag::Table>::_tuples =
    std::vector<ag::DataObjectBase<ag::Table>::Tuple>();
template <>
std::vector<ag::DataObjectBase<ag::Raster>::Tuple> ag::DataObjectBase<ag::Raster>::_tuples =
    std::vector<ag::DataObjectBase<ag::Raster>::Tuple>();
template <>
std::vector<ag::DataObjectBase<ag::FeatureLayer>::Tuple> ag::DataObjectBase<ag::FeatureLayer>::_tuples =
    std::vector<ag::DataObjectBase<ag::FeatureLayer>::Tuple>();

template <>
std::vector<ag::DataObjectBase<ag::Vector>::Tuple> ag::DataObjectBase<ag::Vector>::_tuples =
