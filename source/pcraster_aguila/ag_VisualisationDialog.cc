...
std::map<DataObject *, std::map<T, Dialog *>> VisualisationDialog<T, Dialog>::d_dialogs;

template <class T, class Dialog>
bool VisualisationDialog<T, Dialog>::instanceCreated(DataObject *dataObject, T object)
{
...
template <class T, class Dialog>
Dialog *VisualisationDialog<T, Dialog>::instance(DataObject *dataObject, T object)
{
  return instanceCreated(dataObject, object) ? d_dialogs[dataObject][object] : nullptr;
}

template <class T, class Dialog>
void VisualisationDialog<T, Dialog>::addInstance(DataObject *dataObject, T object, Dialog *dialog)
{
...
template <class T, class Dialog>
void VisualisationDialog<T, Dialog>::removeReference(VisualisationDialog<T, Dialog> *dialog)
{
  for (auto it1 = d_dialogs.begin(); it1 != d_dialogs.end(); ++it1) {
...
template <class T, class Dialog>
VisualisationDialog<T, Dialog>::VisualisationDialog(DataObject *object,
                                                    std::string const &visualisationName,
                                                    QWidget *parent, bool modal, Qt::WindowFlags flags)

    : QDialog(parent, flags), IVisualisation(object, visualisationName)
...
template <class T, class Dialog> VisualisationDialog<T, Dialog>::~VisualisationDialog()
{
...
template <class T, class Dialog> bool VisualisationDialog<T, Dialog>::close()
{
