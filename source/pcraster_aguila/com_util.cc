...
void com_Util::linSpace(std::vector<double>::iterator begin, std::vector<double>::iterator end,
...
void com_Util::logSpace(std::vector<double>::iterator begin, std::vector<double>::iterator end,
                        double min, double max)
{
  size_t imax(0);  // Number of steps minus 1.
  double lmin = NAN;
