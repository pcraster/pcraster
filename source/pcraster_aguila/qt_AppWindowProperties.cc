...
qt::AppWindowProperties::AppWindowProperties(const std::string &appName, const std::string &winName,
                                             const std::string &version, const std::string &about,
                                             const QPixmap &icon)

    : d_appName(appName), d_winName(winName), d_version(version), d_about(about), d_icon(icon)
...
qt::AppWindowProperties::AppWindowProperties(const std::string &appName, const std::string &version,
                                             const QPixmap &icon)
