...
/*!
  \file
  This file contains the implementation of the GeoEASTableDriverTest class.
*/
...
//! suite
boost::unit_test::test_suite*dal::GeoEASTableDriverTest::suite()
{
  boost::unit_test::test_suite* suite = BOOST_TEST_SUITE(__FILE__);
  boost::shared_ptr<GeoEASTableDriverTest> instance(new GeoEASTableDriverTest());

  suite->add(BOOST_CLASS_TEST_CASE(&GeoEASTableDriverTest::testDescription, instance));
  suite->add(BOOST_CLASS_TEST_CASE(&GeoEASTableDriverTest::testUnexisting, instance));
  suite->add(BOOST_CLASS_TEST_CASE(&GeoEASTableDriverTest::testEmpty, instance));
  suite->add(BOOST_CLASS_TEST_CASE(&GeoEASTableDriverTest::testInvalidGrammar, instance));
  suite->add(BOOST_CLASS_TEST_CASE(&GeoEASTableDriverTest::testTable1, instance));
  suite->add(BOOST_CLASS_TEST_CASE(&GeoEASTableDriverTest::testTable2, instance));
...
//! ctor
dal::GeoEASTableDriverTest::GeoEASTableDriverTest()
{
}
...
//! setUp
void dal::GeoEASTableDriverTest::setUp()
{
}
...
//! tearDown
void dal::GeoEASTableDriverTest::tearDown()
{
}



void dal::GeoEASTableDriverTest::testDescription()
{
...
void dal::GeoEASTableDriverTest::testUnexisting()
{
...
void dal::GeoEASTableDriverTest::testEmpty()
{
...
void dal::GeoEASTableDriverTest::testInvalidGrammar()
{
  std::string filename = ":/:/:/:/:";
  GeoEASTableDriver driver;
  bool exceptionCaught;
...
*/
void dal::GeoEASTableDriverTest::testTable1()
{
  std::string filename;
  GeoEASTableDriver driver;
  Table* table;
...
void dal::GeoEASTableDriverTest::testTable2()
{
  std::string filename;
  GeoEASTableDriver driver;
  Table* table;
