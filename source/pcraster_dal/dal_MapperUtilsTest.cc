...
/*!
  \file
  This file contains the implementation of the MapperUtilsTest class.
*/
...
//------------------------------------------------------------------------------
// DEFINITION OF STATIC MAPPERUTILS MEMBERS
//------------------------------------------------------------------------------

//! suite
boost::unit_test::test_suite*MapperUtilsTest::suite()
{
  boost::unit_test::test_suite* suite = BOOST_TEST_SUITE(__FILE__);
  boost::shared_ptr<MapperUtilsTest> instance(new MapperUtilsTest());

  suite->add(BOOST_CLASS_TEST_CASE(&MapperUtilsTest::testStepMap, instance));
  suite->add(BOOST_CLASS_TEST_CASE(&MapperUtilsTest::testTimeStepMap, instance));
...
//------------------------------------------------------------------------------
// DEFINITION OF MAPPERUTILS MEMBERS
//------------------------------------------------------------------------------

//! ctor
MapperUtilsTest::MapperUtilsTest(
         )
{
}
...
//! tearDown
void MapperUtilsTest::tearDown()
{
}



void MapperUtilsTest::testStepMap()
{
  {
...
void MapperUtilsTest::testTimeStepMap()
{
