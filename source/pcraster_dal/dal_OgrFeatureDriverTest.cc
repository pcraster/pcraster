...
/*!
  \file
  This file contains the implementation of the OgrFeatureDriverTest class.
*/
...
//------------------------------------------------------------------------------
// DEFINITION OF STATIC OGRFEATUREDRIVERTEST MEMBERS
//------------------------------------------------------------------------------

//! suite
boost::unit_test::test_suite* OgrFeatureDriverTest::suite()
{
  boost::unit_test::test_suite* suite = BOOST_TEST_SUITE(__FILE__);
  boost::shared_ptr<OgrFeatureDriverTest> instance(new OgrFeatureDriverTest());
  suite->add(BOOST_CLASS_TEST_CASE(
         &OgrFeatureDriverTest::testExists, instance));
  suite->add(BOOST_CLASS_TEST_CASE(
         &OgrFeatureDriverTest::testOpen, instance));
  suite->add(BOOST_CLASS_TEST_CASE(
         &OgrFeatureDriverTest::testDataSpace, instance));
  suite->add(BOOST_CLASS_TEST_CASE(
         &OgrFeatureDriverTest::testRead, instance));
  suite->add(BOOST_CLASS_TEST_CASE(
         &OgrFeatureDriverTest::testQuery, instance));
  suite->add(BOOST_CLASS_TEST_CASE(
         &OgrFeatureDriverTest::testAttributes, instance));
  suite->add(BOOST_CLASS_TEST_CASE(
         &OgrFeatureDriverTest::testSpace, instance));
  suite->add(BOOST_CLASS_TEST_CASE(
         &OgrFeatureDriverTest::testTime, instance));
  suite->add(BOOST_CLASS_TEST_CASE(
         &OgrFeatureDriverTest::testUncertainty, instance));
  suite->add(BOOST_CLASS_TEST_CASE(
         &OgrFeatureDriverTest::testUncertainTemporal, instance));
...
//------------------------------------------------------------------------------
// DEFINITION OF OGRFEATUREDRIVERTEST MEMBERS
//------------------------------------------------------------------------------

//! ctor
OgrFeatureDriverTest::OgrFeatureDriverTest()
{
}



void OgrFeatureDriverTest::testExists()
{
  std::string name;
...
void OgrFeatureDriverTest::testOpen()
{
  std::string name;
...
void OgrFeatureDriverTest::testDataSpace()
{
  std::string name;
  DataSpace space;
  OgrFeatureDriver driver("ESRI Shapefile");
...
void OgrFeatureDriverTest::testRead()
{
  std::string name;
  boost::shared_ptr<FeatureLayer> layer;
  OgrFeatureDriver driver("ESRI Shapefile");
...
void OgrFeatureDriverTest::testQuery()
{
  OgrFeatureDriver driver("ESRI Shapefile");
...
void OgrFeatureDriverTest::testAttributes()
{
...
void OgrFeatureDriverTest::testSpace()
{
...
void OgrFeatureDriverTest::testTime()
{
...
void OgrFeatureDriverTest::testUncertainty()
{
...
void OgrFeatureDriverTest::testUncertainTemporal()
{
