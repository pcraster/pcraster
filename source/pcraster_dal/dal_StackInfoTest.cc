...
/*!
  \file
  This file contains the implementation of the StackInfoTest class.
*/
...
//! suite
boost::unit_test::test_suite*dal::StackInfoTest::suite()
{
  boost::unit_test::test_suite* suite = BOOST_TEST_SUITE(__FILE__);
  boost::shared_ptr<StackInfoTest> instance(new StackInfoTest());

  suite->add(BOOST_CLASS_TEST_CASE(&StackInfoTest::testConstructor, instance));
  suite->add(BOOST_CLASS_TEST_CASE(&StackInfoTest::testBadFormats, instance));
  suite->add(BOOST_CLASS_TEST_CASE(&StackInfoTest::testToString, instance));
  suite->add(BOOST_CLASS_TEST_CASE(&StackInfoTest::testCopy, instance));
...
//! ctor
dal::StackInfoTest::StackInfoTest()
{
}
...
//! tearDown
void dal::StackInfoTest::tearDown()
{
}



void dal::StackInfoTest::testConstructor()
{
...
void dal::StackInfoTest::testBadFormats()
{
...
void dal::StackInfoTest::testToString()
{
  {
...
void dal::StackInfoTest::testCopy()
{
  {
    StackInfo info("soil.csf");
    StackInfo copy(info);
