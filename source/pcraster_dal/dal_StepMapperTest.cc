...
BOOST_AUTO_TEST_CASE(step_mapper)
{
  ...
  {
    StepMapper const mapper(1.0, 2.0, 100.0, 200.0);
    BOOST_TEST(comparable(mapper.destination(-1.0), -100.0));
    BOOST_TEST(comparable(mapper.destination( 0.0),    0.0));
    BOOST_TEST(comparable(mapper.destination( 1.0),  100.0));
    BOOST_TEST(comparable(mapper.destination( 2.0),  200.0));
    BOOST_TEST(comparable(mapper.destination( 3.0),  300.0));
  }
