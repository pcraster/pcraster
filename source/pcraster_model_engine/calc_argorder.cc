 ...
 */
std::vector<ArgOrderIdInfo> ArgOrderAndAddArea::initArgs(std::vector<ArgOrderIdInfo> const &args,
                                                         INT4 *result, size_t len)
{
 ...
 */
void ArgOrderAndAddArea::argOrderAreaLimited(std::vector<ArgOrderIdInfo> &args, INT4 *result, size_t len)
{
...
void ArgOrderAndAddArea::argOrderAddAreaLimited(std::vector<ArgOrderIdInfo> const &argsIn,
