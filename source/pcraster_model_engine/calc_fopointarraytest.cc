...
#include "calc_fopointarrayimpl.inc"
  ...
  }
  {
    ...
    BOOST_TEST(res[0] == 1);
    BOOST_TEST(res[1] == 0);
    BOOST_TEST(res[2] == MV_UINT1);
    BOOST_TEST(res[3] == MV_UINT1);
  }
  {
    float l[4] = {10, 4, 8, 0};
    float r[1] = {4};
  ...
  }
  {
    ...
    BOOST_TEST(r[0] == 1);
    BOOST_TEST(r[1] == 0);
    BOOST_TEST(r[2] == MV_UINT1);
    BOOST_TEST(l[0] == 5);
    BOOST_TEST(l[1] == 0);
    BOOST_TEST(l[2] == MV_INT4);
  }
  {  // pcrcalc337a
    REAL4 const r = -0.047F;
    REAL4 const l = 1.5F;
    BOOST_TEST(special::pow_domainIll(r, l));
  }
}
