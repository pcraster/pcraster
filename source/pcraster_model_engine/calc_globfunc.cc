...
int Do_accutraveltime(void *s, void *f, const void **ins)
{
  ...
  return TravelTime((MAP_REAL8 *)s, (MAP_REAL8 *)f, removed.map(), (const MAP_UINT1 *)ldd,
                    (const MAP_REAL8 *)ins[1], accumTT.map(), constantTransportFraction.map());
}
...
int Do_accutraveltimefraction(void *s, void *f, const void **ins)
{
  ...
  MapReal8 const removed(ldd->nrRows, ldd->nrCols);
  return TravelTime((MAP_REAL8 *)s, (MAP_REAL8 *)f, removed.map(), ldd, (const MAP_REAL8 *)ins[1],
                    accumTT.map(), (const MAP_REAL8 *)ins[3]);
}
...
int Do_accutraveltimefractionremoved(void *removed, const void **ins)
{
  ...
  return TravelTime(s.map(), f.map(), (MAP_REAL8 *)removed, ldd, (const MAP_REAL8 *)ins[1],
                    accumTT.map(), (const MAP_REAL8 *)ins[3]);
}

int Do_diffuse(void *s, void *f, const void **ins)
{
  return Diffuse1((MAP_REAL8 *)s, (MAP_REAL8 *)f, (const MAP_REAL8 *)ins[0], (const MAP_REAL8 *)ins[1],
                  (const MAP_REAL8 *)ins[2]);
}

int Do_spread(void *c, void *z, const void **ins)
{
  return Spread((MAP_REAL8 *)c, (MAP_INT4 *)z, (const MAP_INT4 *)ins[0], (const MAP_REAL8 *)ins[1],
                (const MAP_REAL8 *)ins[2]);
}

int Do_spreadmax(void *c, void *z, const void **ins)
{
  return SpreadMax((MAP_REAL8 *)c, (MAP_INT4 *)z, (const MAP_INT4 *)ins[0], (const MAP_REAL8 *)ins[1],
                   (const MAP_REAL8 *)ins[2], (const MAP_REAL8 *)ins[3]);
}

int Do_spreadldd(void *c, void *z, const void **ins)
{
  return SpreadLdd((MAP_REAL8 *)c, (MAP_INT4 *)z, (const MAP_UINT1 *)ins[0], (const MAP_INT4 *)ins[1],
                   (const MAP_REAL8 *)ins[2], (const MAP_REAL8 *)ins[3]);
}

int Do_dynamicwave(void *q, void *h, const void **in)
{
  return DynamicWave((MAP_REAL8 *)q, (MAP_REAL8 *)h, (const MAP_UINT1 *)in[0], /* ldd */
...
int Do_lddcreate(void *l, void *d, const void **ins)
{
  ...
  return PitRem((MAP_UINT1 *)l, (MAP_REAL8 *)d, t.map(), (const MAP_REAL8 *)ins[0],
                (const MAP_REAL8 *)ins[1], (const MAP_REAL8 *)ins[2], (const MAP_REAL8 *)ins[3],
...
{
  return Idi((MAP_REAL8 *)out, (const MAP_UINT1 *)ins[0], (const MAP_REAL8 *)ins[1],
             (const MAP_REAL8 *)ins[2], (const MAP_REAL8 *)ins[3], (const MAP_REAL8 *)ins[4]);
}
...
{
  return MarkWhileSumLe((MAP_UINT1 *)out, (const MAP_REAL8 *)ins[0], (const MAP_REAL8 *)ins[1],
                        (const MAP_REAL8 *)ins[2]);
}

int Do_markwhilesumge(void *out, const void **ins)
{
  return MarkUntilSumGe((MAP_UINT1 *)out, (const MAP_REAL8 *)ins[0], (const MAP_REAL8 *)ins[1],
                        (const MAP_REAL8 *)ins[2]);
}

int Do_ellipseaverage(void *out, const void **ins)
{
  return EllipseAverage((MAP_REAL8 *)out, (const MAP_REAL8 *)ins[0], (const MAP_REAL8 *)ins[1],
                        (const MAP_REAL8 *)ins[2], (const MAP_REAL8 *)ins[3]);
}
...
{
  return MaskLdd((MAP_UINT1 *)out, (const MAP_UINT1 *)ins[0], (const MAP_UINT1 *)ins[1]);
}

int Do_move(void *out, const void **ins)
{
  return Move((MAP_UINT1 *)out, (const MAP_UINT1 *)ins[0], (const MAP_REAL8 *)ins[1],
              (const MAP_REAL8 *)ins[2]);
}

int Do_shift(void *out, const void **ins)
{
  return Shift((MAP_REAL8 *)out, (const MAP_REAL8 *)ins[0], (const MAP_REAL8 *)ins[1],
               (const MAP_REAL8 *)ins[2]);
}

int Do_shift0(void *out, const void **ins)
{
  return Shift0((MAP_REAL8 *)out, (const MAP_REAL8 *)ins[0], (const MAP_REAL8 *)ins[1],
                (const MAP_REAL8 *)ins[2]);
}
...
{
  return BirdsSpread((MAP_UINT1 *)out, (const MAP_REAL8 *)ins[0], (const MAP_REAL8 *)ins[1],
                     (const MAP_REAL8 *)ins[2], (const MAP_REAL8 *)ins[3], (const MAP_REAL8 *)ins[4],
...
{
  return InfluenceSimpleGauss((MAP_REAL8 *)out, (const MAP_REAL8 *)ins[0], (const MAP_REAL8 *)ins[1],
                              (const MAP_REAL8 *)ins[2]);
}
...
int Do_distributesimplegauss(void *out, const void **ins)
{
  ...
  return DistributeSimpleGauss(o, t.map(), (const MAP_REAL8 *)ins[0], (const MAP_REAL8 *)ins[1],
                               (const MAP_REAL8 *)ins[2]);
}

int Do_ibngauss(void *out, const void **ins)
{
  return IBNGauss((MAP_REAL8 *)out, (const MAP_REAL8 *)ins[0], (const MAP_REAL8 *)ins[1],
                  (const MAP_REAL8 *)ins[2]);
}

int Do_horizontan(void *out, const void **ins)
{
  return HorizonTangent((MAP_REAL8 *)out, (const MAP_REAL8 *)ins[0], (const MAP_REAL8 *)ins[1]);
}

int Do_riksfraction(void *out, void const **ins)
{
  return riksFraction((MAP_REAL8 *)out, (MAP_UINT1 const *)ins[0], (MAP_REAL8 const *)ins[1],
                      (MAP_REAL8 const *)ins[2]);
}

int Do_squarefraction(void *out, void const **ins)
{
  return squareFraction((MAP_REAL8 *)out, (MAP_UINT1 const *)ins[0], (MAP_REAL8 const *)ins[1],
                        (MAP_REAL8 const *)ins[2]);
}
...
{
  return vf_divergence((MAP_REAL8 *)out, (MAP_REAL8 const *)ins[0], (MAP_REAL8 const *)ins[1]);
}

int Do_diver(void *out, void const **ins)
{
  return vf_diver((MAP_REAL8 *)out, (MAP_REAL8 const *)ins[0], (MAP_REAL8 const *)ins[1],
                  (MAP_REAL8 const *)ins[2], (MAP_REAL8 const *)ins[3]);
}

int Do_lax(void *out, void const **ins)
{
  return vf_lax((MAP_REAL8 *)out, (MAP_REAL8 const *)ins[0], (MAP_REAL8 const *)ins[1]);
}
