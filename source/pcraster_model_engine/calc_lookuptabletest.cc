...
BOOST_AUTO_TEST_CASE(testInterpolateMWF)
{
  ...
  struct MWFTest : public calc::TestLookupCtor {
    ...
    MWFTest(const char *table, size_t nrCols) : TestLookupCtor(table, std::vector<VS>(nrCols, VS_S))
    {
      setPrefixStableSort(1);
    }

    bool interpolate(double &r, double keyValue) const
    {
  ...
  }
  {
    ...
    TestLookupCtor stableSorted("4 0 0.0  -100 \n"   // 0
                                "4 0 3.0  -101  \n"  // 1
                                "4 1 6.0  -102 \n"   // 2
                                "4 1 9.0  -103 \n"   // 3
                                "4 0 12.0 -104 \n"   // 4
