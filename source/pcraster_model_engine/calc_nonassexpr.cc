...
calc::NonAssExpr::NonAssExpr(ASTNode *transferedExpr) : d_expr(transferedExpr)
{
  setNrReturns(1);
}

//! Copy constructor.
calc::NonAssExpr::NonAssExpr(NonAssExpr const &rhs) : ASTNode(rhs), d_expr(rhs.d_expr->createClone())
{
  setNrReturns(1);
}
