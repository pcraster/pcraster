...
calc::ObjectLinkMethod::ObjectLinkMethod(const std::string &name) : d_name(name)
{
}
...
calc::ObjectLinkMeta::ObjectLinkMeta(const std::string &className,
                                     const ObjectLinkFactoryPtr &objectLinkFactory)
    : d_className(className), d_objectLinkFactory(objectLinkFactory)
{
  // insert default ctor
...
calc::ObjectLinkMeta::ObjectLinkMeta(ObjectLinkMeta const &rhs)
    : d_className(rhs.d_className), d_objectLinkFactory(rhs.d_objectLinkFactory),
...
const calc::ObjectLinkMeta::MethodMap &calc::ObjectLinkMeta::methodMap() const
{
  return d_methods;
}
