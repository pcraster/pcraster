 ...
 */
calc::BandMap::BandMap(const std::string &fileName) : GridMap(fileName), d_map(fileName)
{
...
calc::BandMap::BandMap(const std::string &fileName, const geo::RasterSpace &rs, VS vs)
