 ...
 */
calc::FieldArgs::FieldArgs(const Element &p, const Operator &o, FieldExprArgs &inArgs)
 ...
 * hack for modellink*
 */
calc::FieldArgs::FieldArgs(const Element &p, const Operator &o, const FieldExprArgs &inArgs)
 ...
 */
void calc::FieldArgs::restrictFieldArgs(size_t fieldArgOffset)
{
  // check if arguments match with the types of the operation
  try {
