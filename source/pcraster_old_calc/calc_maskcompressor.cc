 ...
 *
 */
calc::MaskCompressor::MaskCompressor(const geo::RasterSpace &rs, const unsigned char *const mask)
    : Compressor(rs), d_mask(rs.nrCells()), d_compressedToDecompressed(rs.nrCells())
{
...
void calc::MaskCompressor::decompress(DecompressedData &d, const void *compressedData) const
{
