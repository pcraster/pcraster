 ...
 */
calc::ModelLinkInit::ModelLinkInit(const calc::Symbol &modelId, const calc::Symbol &modelName,
                                   const std::string &strArg, calc::FieldExprArgs &args)
    : calc::Statement(modelId), d_posOfModelName(modelName), d_args(args), d_sig(strArg, d_args.size())
{
  try {
