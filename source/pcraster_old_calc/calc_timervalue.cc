...
calc::TimerValue::TimerValue(const TimerValue &t) : Symbol(t), d_vs(t.d_vs), d_value(t.d_value)
{
}
...
void calc::checkTimerSection(const TimerValue &start, const TimerValue &end, const TimerValue &slice)
{
