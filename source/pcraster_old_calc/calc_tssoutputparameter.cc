...
calc::TssOutputParameter::TssOutputParameter(const calc::ParsPar &par, const calc::WriteInfo &w,
                                             bool constant)
    : calc::TssParameter(par, constant, false), d_value(nrElements(), nullptr)
{
...
static int GetMaxId(const MAP_INT4 *id)
{
  int r = 0;
