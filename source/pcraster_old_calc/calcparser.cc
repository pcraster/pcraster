...
{
  s.posError("function " + s.qName() + " is only legal in the dynamic section");
};
...
calc::Constant Parser::createCastedConstant(const ANTLRTokenPtr &convF, const calc::Symbol &nr) const
{
...
void Parser::zzdflthandlers(int _signal, int *_retsignal)
{
  *_retsignal = _signal;
}

void Parser::externalBindings(int *_retsignal, calc::RunSettings &rs)
{
...
void Parser::model(int *_retsignal)
{
#line 404 "calcparser.g"
  ...
  int _signal = NoSignal;
  *_retsignal = NoSignal;
  if (((setwd1[LA(1)] & 0x8) != 0) && ((setwd1[LA(2)] & 0x10) != 0)) {
#line 404 "calcparser.g"
    {
      if ((LA(1) == TOK_MODEL)) {
#line 404 "calcparser.g"
...
#line 405 "calcparser.g"
    ...
    if (((setwd1[LA(1)] & 0x20) != 0) && ((setwd1[LA(2)] & 0x40) != 0)) {
...
void Parser::modelProlog(int *_retsignal)
{
...
void Parser::modelCode(int *_retsignal)
{
...
void Parser::bindingSection(int *_retsignal)
{
...
void Parser::areaMapSection(int *_retsignal)
{
...
void Parser::timer(int *_retsignal)
{
...
#line 454 "calcparser.g"
  {
    if (((setwd2[LA(1)] & 0x40) != 0) && ((setwd2[LA(2)] & 0x80) != 0)) {
...
calc::TimerValue Parser::timerValue(int *_retsignal)
{
...
void Parser::reportMomentDef(int *_retsignal)
{
...
void Parser::bindingDefinition(int *_retsignal)
{
...
void Parser::bindingRight(int *_retsignal, const calc::DefPar &par)
{
...
#line 525 "calcparser.g"
            ...
            // (see test/pcrcalc277)
            try {
              script()->addSymbol(par.indexTable(p, true, tokenOp(indF)));
            } catch (com::Exception &msg) {
              indexTableFile.posError(msg.messages());
            }
...
void Parser::indecesDef(int *_retsignal, std::vector<calc::ParsIndex *> &indDef)
{
...
calc::ParsIndex *Parser::indexDef(int *_retsignal)
{
...
void Parser::reportMoments(int *_retsignal, std::vector<calc::ParsReportMoment> &m)
{
...
void Parser::reportMoment(int *_retsignal, calc::ParsReportMoment &p)
{
...
int Parser::reportMomentStep(int *_retsignal)
{
  int _retv = 0;
...
calc::IdList Parser::idList(int *_retsignal)
{
  calc::IdList _retv;
...
void Parser::codeBlocks(int *_retsignal, calc::StatementBlock *inclIn)
{
...
#line 644 "calcparser.g"
          ...
          if ((setwd5[LA(1)] & 0x10) != 0) {
#line 649 "calcparser.g"
            {
#line 646 "calcparser.g"
              auto *b = new calc::InnerStatementBlock(element(LT(1)), inclIn);
...
#line 650 "calcparser.g"
              {
                while (((setwd5[LA(1)] & 0x20) != 0) && ((setwd5[LA(2)] & 0x40) != 0)) {
#line 650 "calcparser.g"
                  codeBlock(&_signal, b);
                  if (_signal != 0) {
                    goto _handler;
...
void Parser::codeBlock(int *_retsignal, calc::StatementBlock *inclIn)
{
...
void Parser::foreach (int *_retsignal, calc::StatementBlock * inclIn)
{
...
#line 700 "calcparser.g"
  ...
  calc::Symbol const iter;
  calc::IdList in;
  calc::IdList except;
  calc::IdList const s;
  bool const ascending = true;
...
#line 714 "calcparser.g"
  f = new calc::ForEach(element(posF), inclIn, symbol(iterId), in, except, s, ascending);
...
void Parser::repeat(int *_retsignal, calc::StatementBlock *inclIn)
{
...
#line 734 "calcparser.g"
  {
    ...
    args[0] = condition;
    ru->addCondition(new calc::BranchExprImpl(*(args[0]), calc::major2op(OP_TEST_UNTIL), args));
  }
  consume();
  return;
fail:
...
void Parser::assignment(int *_retsignal, calc::StatementBlock *inclIn, const calc::WriteInfo &w)
{
...
void Parser::assignmentTail(int *_retsignal, calc::StatementBlock *inclIn, const calc::WriteInfo &w,
                            calc::UsePar &par)
{
...
#line 776 "calcparser.g"
      ...
      inclIn->addStatement(new calc::Assignment(inclIn, w, par, newExpr));
    } else {
      if ((LA(1) == TOK_COMMA)) {
...
#line 806 "calcparser.g"
              calc::FieldExprArgs args;
              calc::Symbol const modelName = symbol(theId);
              std::string strArg;
              consume();
...
#line 830 "calcparser.g"
                ...
                inclIn->addStatement(new calc::DoubleAssignment(inclIn, leftPars[0], w, leftPars[0],
                                                                leftPars[1], sym1, op1, op2, args));
...
void Parser::statementSep(int *_retsignal)
{
...
calc::FieldExpr *Parser::expr(int *_retsignal, calc::StatementBlock *inclIn)
{
...
calc::FieldExpr *Parser::xor_expr(int *_retsignal, calc::StatementBlock *inclIn)
{
  calc::FieldExpr *_retv = nullptr;
...
calc::FieldExpr *Parser::and_expr(int *_retsignal, calc::StatementBlock *inclIn)
{
  calc::FieldExpr *_retv = nullptr;
...
calc::FieldExpr *Parser::eq_expr(int *_retsignal, calc::StatementBlock *inclIn)
{
  calc::FieldExpr *_retv = nullptr;
...
calc::FieldExpr *Parser::comp_expr(int *_retsignal, calc::StatementBlock *inclIn)
{
  calc::FieldExpr *_retv = nullptr;
...
calc::FieldExpr *Parser::add_expr(int *_retsignal, calc::StatementBlock *inclIn)
{
  calc::FieldExpr *_retv = nullptr;
...
#line 924 "calcparser.g"
      ...
      args[0] = _retv;
      args[1] = right;
      const calc::Operator &op = calc::major2op(opS->getType() == TOK_PLUS ? OP_BADD : OP_BMIN);
...
calc::FieldExpr *Parser::mult_expr(int *_retsignal, calc::StatementBlock *inclIn)
{
  calc::FieldExpr *_retv = nullptr;
...
calc::FieldExpr *Parser::pow_expr(int *_retsignal, calc::StatementBlock *inclIn)
{
  calc::FieldExpr *_retv = nullptr;
...
calc::FieldExpr *Parser::sign_expr(int *_retsignal, calc::StatementBlock *inclIn)
{
  calc::FieldExpr *_retv = nullptr;
...
#line 962 "calcparser.g"
  {
    while (((setwd8[LA(1)] & 0x8) != 0) && ((setwd8[LA(2)] & 0x10) != 0)) {
...
calc::FieldExpr *Parser::not_expr(int *_retsignal, calc::StatementBlock *inclIn)
{
  calc::FieldExpr *_retv = nullptr;
...
calc::FieldExpr *Parser::misc_expr(int *_retsignal, calc::StatementBlock *inclIn)
{
  calc::FieldExpr *_retv = nullptr;
...
#line 1010 "calcparser.g"
          calc::Symbol nr;
          if (((setwd9[LA(1)] & 0x1) != 0) && ((setwd9[LA(2)] & 0x2) != 0)) {
...
#line 1012 "calcparser.g"
            ...
            if (((setwd9[LA(1)] & 0x4) != 0) && ((setwd9[LA(2)] & 0x8) != 0)) {
...
#line 1027 "calcparser.g"
          ...
          try {
            _retv = new calc::LookupExpr(element(lookF), tokenOp(lookF), table, args);
          } catch (...) {
            calc::cleanUp(args);
            throw;
          }
...
void Parser::modelLinkArgs(int *_retsignal, calc::StatementBlock *inclIn, std::string &strArg,
                           calc::FieldExprArgs &args)
{
...
#line 1132 "calcparser.g"
  {
    if ((LA(1) == TOK_REFERENCE) && ((setwd10[LA(2)] & 0x4) != 0)) {
#line 1132 "calcparser.g"
      zzmatch_wsig(TOK_REFERENCE, _handler);
...
void Parser::exprList(int *_retsignal, calc::StatementBlock *inclIn, calc::FieldExprArgs &args)
{
...
calc::ConstructPar Parser::parWithIndeces(int *_retsignal, calc::StatementBlock *s)
{
...
calc::Symbol Parser::arrayIndex(int *_retsignal)
{
  calc::Symbol _retv;
...
calc::Symbol Parser::qid(int *_retsignal)
{
  calc::Symbol _retv;
...
calc::Symbol Parser::number(int *_retsignal)
{
  calc::Symbol _retv;
...
calc::Symbol Parser::unsignedNumber(int *_retsignal)
{
  calc::Symbol _retv;
...
calc::Symbol Parser::sign(int *_retsignal)
{
  calc::Symbol _retv;
