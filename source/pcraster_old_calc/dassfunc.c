...
{
  return Accu((MAP_REAL8 *)s, (MAP_REAL8 *)f, (const MAP_UINT1 *)ins[0], (const MAP_REAL8 *)ins[1]);
}

int Do_accucapacity(void *s, void *f, const void **ins)
{
  return AccuLtc((MAP_REAL8 *)s, (MAP_REAL8 *)f, (const MAP_UINT1 *)ins[0], (const MAP_REAL8 *)ins[1],
                 (const MAP_REAL8 *)ins[2]);
}

int Do_accuthreshold(void *s, void *f, const void **ins)
{
  return AccuTt((MAP_REAL8 *)s, (MAP_REAL8 *)f, (const MAP_UINT1 *)ins[0], (const MAP_REAL8 *)ins[1],
                (const MAP_REAL8 *)ins[2]);
}

int Do_accufraction(void *s, void *f, const void **ins)
{
  return AccuFraction((MAP_REAL8 *)s, (MAP_REAL8 *)f, (const MAP_UINT1 *)ins[0],
                      (const MAP_REAL8 *)ins[1], (const MAP_REAL8 *)ins[2]);
}

int Do_accutrigger(void *s, void *f, const void **ins)
{
  return AccuTrigger((MAP_REAL8 *)s, (MAP_REAL8 *)f, (const MAP_UINT1 *)ins[0],
                     (const MAP_REAL8 *)ins[1], (const MAP_REAL8 *)ins[2]);
}
...
#error ARE YOU SURE?
#else
  r = PitRem((MAP_UINT1 *)l, (MAP_REAL8 *)d, t, (const MAP_REAL8 *)ins[0], (const MAP_REAL8 *)ins[1],
