...
int Do_ne_1_ss(UINT1 *v1, const UINT1 *v2, size_t n)
    CMP_SS_1(UINT1, !=) int Do_ne_1_ns(const UINT1 *v1, UINT1 *v2, size_t n)
        CMP_NS_1(UINT1, !=) int Do_eq_1_ss(UINT1 *v1, const UINT1 *v2, size_t n)
            CMP_SS_1(UINT1, ==) int Do_eq_1_ns(const UINT1 *v1, UINT1 *v2, size_t n) CMP_NS_1(UINT1, ==)

    /* CMP: */
    void Do_ne_4_ss(UINT1 *r, const INT4 *v1, const INT4 *v2, size_t n)
        CMP_SS(INT4, !=) void Do_ne_4_ns(UINT1 *r, const INT4 *v1, const INT4 *v2, size_t n)
            CMP_NS(INT4, !=) void Do_eq_4_ss(UINT1 *r, const INT4 *v1, const INT4 *v2, size_t n)
                CMP_SS(INT4, ==) void Do_eq_4_ns(UINT1 *r, const INT4 *v1, const INT4 *v2, size_t n)
                    CMP_NS(INT4, ==) void Do_gt_4_ss(UINT1 *r, const INT4 *v1, const INT4 *v2, size_t n)
                        CMP_SS(INT4, >) void Do_gt_4_ns(UINT1 *r, const INT4 *v1, const INT4 *v2,
                                                        size_t n)
                            CMP_NS(INT4, >) void Do_gt_4_sn(UINT1 *r, const INT4 *v1, const INT4 *v2,
                                                            size_t n)
                                CMP_SN(INT4, >) void Do_ge_4_ss(UINT1 *r, const INT4 *v1, const INT4 *v2,
                                                                size_t n)
                                    CMP_SS(INT4, >=) void Do_ge_4_ns(UINT1 *r, const INT4 *v1,
                                                                     const INT4 *v2, size_t n)
                                        CMP_NS(INT4, >=) void Do_ge_4_sn(UINT1 *r, const INT4 *v1,
                                                                         const INT4 *v2, size_t n)
                                            CMP_SN(INT4, >=) void Do_lt_4_ss(UINT1 *r, const INT4 *v1,
                                                                             const INT4 *v2, size_t n)
{
...
void Do_ne_s_ss(UINT1 *r, const REAL4 *v1, const REAL4 *v2, size_t n)
    CMP_SS(REAL4, !=) void Do_ne_s_ns(UINT1 *r, const REAL4 *v1, const REAL4 *v2, size_t n)
        CMP_NS(REAL4, !=) void Do_eq_s_ss(UINT1 *r, const REAL4 *v1, const REAL4 *v2, size_t n)
            CMP_SS(REAL4, ==) void Do_eq_s_ns(UINT1 *r, const REAL4 *v1, const REAL4 *v2, size_t n)
                CMP_NS(REAL4, ==) void Do_gt_s_ss(UINT1 *r, const REAL4 *v1, const REAL4 *v2, size_t n)
                    CMP_SS(REAL4, >) void Do_gt_s_ns(UINT1 *r, const REAL4 *v1, const REAL4 *v2,
                                                     size_t n)
                        CMP_NS(REAL4, >) void Do_gt_s_sn(UINT1 *r, const REAL4 *v1, const REAL4 *v2,
                                                         size_t n)
                            CMP_SN(REAL4, >) void Do_ge_s_ss(UINT1 *r, const REAL4 *v1, const REAL4 *v2,
                                                             size_t n)
                                CMP_SS(REAL4, >=) void Do_ge_s_ns(UINT1 *r, const REAL4 *v1,
                                                                  const REAL4 *v2, size_t n)
                                    CMP_NS(REAL4, >=) void Do_ge_s_sn(UINT1 *r, const REAL4 *v1,
                                                                      const REAL4 *v2, size_t n)
                                        CMP_SN(REAL4, >=) void Do_lt_s_ss(UINT1 *r, const REAL4 *v1,
                                                                          const REAL4 *v2, size_t n)
{
...
void Do_if_else_1_sss(UINT1 *r, const UINT1 *test, const UINT1 *t, const UINT1 *f, size_t n)
    DO_IFELSE_SXX(t[i], f[i], UINT1) void Do_if_else_1_ssn(UINT1 *r, const UINT1 *test, const UINT1 *t,
                                                           const UINT1 *f, size_t n)
        DO_IFELSE_SXX(t[i], f[0], UINT1) void Do_if_else_1_snn(UINT1 *r, const UINT1 *test,
                                                               const UINT1 *t, const UINT1 *f, size_t n)
            DO_IFELSE_SXX(t[0], f[0], UINT1) void Do_if_else_1_sns(UINT1 *r, const UINT1 *test,
                                                                   const UINT1 *t, const UINT1 *f,
                                                                   size_t n) DO_IFELSE_SXX(t[0], f[i],
                                                                                           UINT1)
...
void Do_if_else_4_sss(INT4 *r, const UINT1 *test, const INT4 *t, const INT4 *f, size_t n)
    DO_IFELSE_SXX(t[i], f[i], INT4) void Do_if_else_4_ssn(INT4 *r, const UINT1 *test, const INT4 *t,
                                                          const INT4 *f, size_t n)
        DO_IFELSE_SXX(t[i], f[0], INT4) void Do_if_else_4_snn(INT4 *r, const UINT1 *test, const INT4 *t,
                                                              const INT4 *f, size_t n)
            DO_IFELSE_SXX(t[0], f[0], INT4) void Do_if_else_4_sns(INT4 *r, const UINT1 *test,
                                                                  const INT4 *t, const INT4 *f, size_t n)
                DO_IFELSE_SXX(t[0], f[i], INT4) void Do_if_else_4_nns(INT4 *r, const UINT1 *test,
                                                                      const INT4 *t, const INT4 *f,
                                                                      size_t n)
{
  size_t i = 0;
  PRECOND(*test == 0 || *test == 1);
