...
{
  return Downstreamtotal((MAP_REAL8 *)out, (const MAP_UINT1 *)ins[0], (const MAP_REAL8 *)ins[1]);
}
...
{
  return Kinematic((MAP_REAL8 *)out, (const MAP_UINT1 *)ins[0], (const MAP_REAL8 *)ins[1],
                   (const MAP_REAL8 *)ins[2], (const MAP_REAL8 *)ins[3], (const MAP_REAL8 *)ins[4],
...
int Do_distributesimplegauss(void *out, const void **ins)
{
  ...
  return DistributeSimpleGauss(o, t, (const MAP_REAL8 *)ins[0], (const MAP_REAL8 *)ins[1],
                               (const MAP_REAL8 *)ins[2]);
  DeleteMAP_REAL8(t);
}
