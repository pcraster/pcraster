...
class TestPickle(testcase.TestCase):
  ...
  def test_3(self):
    """ unpickle nominal """
    field_pkl = pickle.load(open("pickle_nominal.pkl", "r"))
  ...
  def test_7(self):
    """ unpickle ldd """
    field_pkl = pickle.load(open("pickle_ldd.pkl", "r"))
  ...
  def test_9(self):
    """ unpickle class """
    p = pickle.load(open("pickle_class.pkl", "r"))
