...
BOOST_AUTO_TEST_CASE(dummy_compactor)
{
  ...
  BOOST_TEST(dal::comparable(compactor( 0.0,  0.0), REAL4(0.0)));
  BOOST_TEST(dal::comparable(compactor( 5.0,  0.0), REAL4(5.0)));
  BOOST_TEST(dal::comparable(compactor( 0.0, -5.0), REAL4(0.0)));
  BOOST_TEST(dal::comparable(compactor( 0.0,  5.0), REAL4(0.0)));
}
...
BOOST_AUTO_TEST_CASE(sand_compactor)
{
  ...
  BOOST_TEST(dal::comparable(compactor( 0.0,   0.0), REAL4(0.0)));
  BOOST_TEST(dal::comparable(compactor( 0.0, 100.0), REAL4(0.0)));
  BOOST_TEST(dal::comparable(compactor( 0.0, 100.0), REAL4(0.0)));
}
