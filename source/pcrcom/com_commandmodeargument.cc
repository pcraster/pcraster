...
*/
com::CommandModeArgument::CommandModeArgument(char character, const std::string &name,
...
/*!
  ...
  \param     isRequired Whether the argument is required or not.
*/
com::CommandModeArgument::CommandModeArgument(const std::string &name,
                                              const std::string &valueDescription,
                                              const std::string &description, bool isRequired)
...
*/
void com::CommandModeArgument::setArguments(const CommandLineArguments &arguments)
{
...
void com::CommandModeArgument::printDescription(std::ostream &stream, size_t offset, size_t width) const
{
