...
template <typename R> com::Interval<R>::Interval()
{
}
 ...
 */
template <typename R> bool com::Interval<R>::less(const Interval<R> &rhs) const
{
  if (max() == rhs.min()) {
...
template <typename R> bool com::Interval<R>::operator==(const Interval &rhs) const
{
  return min() == rhs.min() && max() == rhs.max() && valid(min()) == rhs.valid(rhs.min()) &&
         valid(max()) == rhs.valid(rhs.max());
}

//! lowest value representable
template <typename R> R com::Interval<R>::minLimit()
{
  return NumericLimits<R>::minValue();
}

//! highest value representable
template <typename R> R com::Interval<R>::maxLimit()
{
  return NumericLimits<R>::maxValue();
}

template <typename R> R com::Interval<R>::centre() const
{
  return (min() + max()) / 2;
}

template <typename R> void com::Interval<R>::print(std::ostream &stream) const
{
  if (min() == max()) {
    // single value
    stream << min();
...
template <typename R> std::ostream &com::operator<<(std::ostream &stream, const Interval<R> &i)
{
  i.print(stream);
  return stream;
}

template <typename R> com::GreaterThan<R> *com::GreaterThan<R>::createClone() const
{
  return new GreaterThan(*this);
}

template <typename R> std::string com::GreaterThan<R>::msg() const
{
...
template <typename R> std::string com::GreaterThanEqualTo<R>::msg() const
{
  std::ostringstream str;
...
template <typename R> com::GreaterThanEqualTo<R> *com::GreaterThanEqualTo<R>::createClone() const
{
  return new GreaterThanEqualTo(*this);
}

template <typename R> std::string com::LessThan<R>::msg() const
{
  std::ostringstream str;
...
template <typename R> com::LessThan<R> *com::LessThan<R>::createClone() const
{
  return new LessThan(*this);
}

template <typename R> std::string com::LessThanEqualTo<R>::msg() const
{
  std::ostringstream str;
...
template <typename R> com::LessThanEqualTo<R> *com::LessThanEqualTo<R>::createClone() const
{
  return new LessThanEqualTo(*this);
}

template <typename R> std::string com::EqualTo<R>::msg() const
{
  std::ostringstream str;
...
template <typename R> com::EqualTo<R> *com::EqualTo<R>::createClone() const
{
  return new EqualTo(*this);
}

template <typename R> std::string com::AnythingInterval<R>::msg() const
{
  return "anything";
}

template <typename R> com::AnythingInterval<R> *com::AnythingInterval<R>::createClone() const
{
 ...
 */
template <typename R>
com::BetweenLimits<R>::BetweenLimits(const LowerLimit<R> &lowerLimit, const UpperLimit<R> &upperLimit)
    : d_lowerLimit(lowerLimit.createClone()), d_upperLimit(upperLimit.createClone())
{
...
//! dtor
template <typename R> com::BetweenLimits<R>::~BetweenLimits()
{
  clean();
}

template <typename R> void com::BetweenLimits<R>::clean()
{
  delete d_lowerLimit;
...
com::BetweenLimits<R>::BetweenLimits(const BetweenLimits &rhs)
    : Interval<R>(rhs), d_lowerLimit(rhs.d_lowerLimit->createClone()),
      d_upperLimit(rhs.d_upperLimit->createClone())
{
}

template <typename R> com::BetweenLimits<R> *com::BetweenLimits<R>::createClone() const
{
  return new BetweenLimits(*this);
}

template <typename R>
com::BetweenLimits<R> &com::BetweenLimits<R>::operator=(const BetweenLimits<R> &rhs)
{
  if (this != &rhs) {
    delete d_lowerLimit;
...
template <typename R> bool com::BetweenLimits<R>::valid(R v) const
{
  return d_lowerLimit->valid(v) && d_upperLimit->valid(v);
}

template <typename R> bool com::BetweenLimits<R>::operator<(R v) const
{
...
template <typename R> std::string com::BetweenLimits<R>::msg() const
{
                         ...
                         OD &high)
{
  ...
  bool const correct = parse(copyStr.begin(), copyStr.end(),
                             ...
                             (real_p[assign_a(singleValue)] |
                              ((ch_p('[')[append(ranges)] | ch_p('<')[append(ranges)]) >>
                               (!real_p[assign_a(low)]) >> ',' >> !real_p[assign_a(high)] >>
                               (ch_p(']')[append(ranges)] | ch_p('>')[append(ranges)]))),
                             //  End grammar
                             space_p)
                           .full;
 ...
 */
template <typename R> com::Interval<R> *com::createIntervalFromLookupTableKey(const std::string &str)
{
...
void deleteClone(Interval<double> const *c)
{
  delete c;
}
...
void deleteClone(Interval<float> const *c)
{
  delete c;
}
}  // namespace com
