...
double geo::AverageFilter::result(const SimpleRaster<double> &source, size_t rowSrc, size_t colSrc,
                                  size_t rowFlt, size_t colFlt, size_t nrRows, size_t nrCols) const
{
  double result = 0.0;
  double count = 0.0;
