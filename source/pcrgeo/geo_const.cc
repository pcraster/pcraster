...
/*!
  \fn const int geo_Const::YINCRB2T

  Projection type: y increases from bottom to top.
*/
...
/*!
  \fn const int geo_Const::LEGENDUPPERLEFT

  Place legend in upper left corner of display window.
*/
...
/*!
  \fn const int geo_Const::LEGENDLOWERLEFT

  Place legend in lower left corner of display window.
*/
...
/*!
  \fn const int geo_Const::VECTOR

  Code for vector topology.
*/
