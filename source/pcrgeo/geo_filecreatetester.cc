...
public:
  ThrowOrReturn(const com::PathName &m1, const com::PathName &m2, bool throwWhatDifferent)
      : d_m1(m1), d_m2(m2), d_throwWhatDifferent(throwWhatDifferent)
  {
  }
...
public:
  DiffMap(bool diffMapWanted, ThrowOrReturn &tr, const RasterSpace &rs)
      : d_diffMapWanted(diffMapWanted), d_tr(tr), d_rs(rs)
  {
  }
...
bool geo::FileCreateTester::equalToTss(const com::PathName &eqTo, bool throwWhatDifferent) const
{
  com::Table tss1;
  std::ifstream i1;
...
bool geo::FileCreateTester::equalToCsf(const com::PathName &eqTo, bool throwWhatDifferent) const
{
