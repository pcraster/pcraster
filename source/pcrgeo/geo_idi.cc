...
bool geo::idi(double &value, const std::vector<IdiPoint<Point>> &points, double idp, size_t maxNr,
              double radius, const Point &c)
{
...
namespace geo
{
template bool idi<CellLoc>(double &value, const std::vector<IdiPoint<CellLoc>> &points, double idp,
                           size_t maxNr, double radius, const CellLoc &c);
template bool idi<Point<double, 2>>(double &value, const std::vector<IdiPoint<Point<double, 2>>> &points,
                                    double idp, size_t maxNr, double radius, const Point<double, 2> &c);
}  // namespace geo
