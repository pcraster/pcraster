...
static bool neighbourTarget(geo::LinearLoc s, const geo::RasterDim &rd, geo::LDD::Code l, bool outside)
{
  using namespace geo;
...
static bool nbTarget(geo::LinearLoc s, const geo::RasterDim &rd, geo::NB::Code l, bool outside)
{
  using namespace geo;
