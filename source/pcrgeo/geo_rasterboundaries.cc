...
/*!
  \file
  This file contains the implementation of the RasterBoundaries class.
*/
...
class RasterBoundariesPrivate
{
public:

  RasterBoundariesPrivate()
  {
  }
...
geo::RasterBoundaries::RasterBoundaries()
{
}
