...
geo_Rectangle::geo_Rectangle(const geo_Rectangle &rectangle)
    ...
    : d_upperLeft(rectangle.getUpperLeft()), d_lowerRight(rectangle.getLowerRight())
...
*/
geo_Rectangle::geo_Rectangle(REAL8 ulx, REAL8 uly, REAL8 lrx, REAL8 lry)
{
...
*/
void geo_Rectangle::setRectangle(REAL8 x, REAL8 y, REAL8 width, REAL8 height)
{
  moveUpperLeft(x, y);
...
*/
geo_Rectangle bounds(const geo_Rectangle &rect1, const geo_Rectangle &rect2, int projection)
{
  REAL8 ulX = NAN;
  REAL8 lrX = NAN;
  REAL8 ulY = 0.0;
  ...
  ulX = rect1.getUpperLeft()[geo::X] < rect2.getUpperLeft()[geo::X] ? rect1.getUpperLeft()[geo::X]
                                                                    : rect2.getUpperLeft()[geo::X];
  lrX = rect1.getLowerRight()[geo::X] > rect2.getLowerRight()[geo::X] ? rect1.getLowerRight()[geo::X]
                                                                      : rect2.getLowerRight()[geo::X];

  if (projection == geo_Const::YINCRB2T) {
    ulY = rect1.getUpperLeft()[geo::Y] > rect2.getUpperLeft()[geo::Y] ? rect1.getUpperLeft()[geo::Y]
                                                                      : rect2.getUpperLeft()[geo::Y];
    lrY = rect1.getLowerRight()[geo::Y] < rect2.getLowerRight()[geo::Y] ? rect1.getLowerRight()[geo::Y]
...
*/
bool intersect(const geo_Rectangle &rect1, const geo_Rectangle &rect2, int projection)
{
  REAL8 maxX = NAN;
  REAL8 minX = NAN;
  REAL8 maxY = NAN;
...
*/
geo_Rectangle intersection(const geo_Rectangle &rect1, const geo_Rectangle &rect2, int projection)
{
  REAL8 ulX = NAN;
  REAL8 lrX = NAN;
  REAL8 ulY = NAN;
