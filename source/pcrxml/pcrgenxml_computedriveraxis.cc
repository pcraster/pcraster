...
//! ctor
pcrxml::ComputedRiverAxis::ComputedRiverAxis(const QDomElement &element)
...
//! copy ctor
pcrxml::ComputedRiverAxis::ComputedRiverAxis(const ComputedRiverAxis &src) : pcrxml::Element(src)
{
}
