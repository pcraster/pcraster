...
//! ctor
pcrxml::DataEnvelop::DataEnvelop(const QDomElement &element)
    : PCDATAElement(element, d_elementName), encoding(element, "encoding", true)
{
}
...
//! string ctor
pcrxml::DataEnvelop::DataEnvelop(const std::string &contents) : PCDATAElement(contents)
{
}
...
pcrxml::DataEnvelop::DataEnvelop(const DataEnvelop &src)
    : pcrxml::PCDATAElement(src), encoding(src.encoding)
{
}
