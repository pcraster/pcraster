...
{
template <>
const char *EnumNmToken<DimensionBaseEnum>::d_strings[] = {"Length",
                                                           "Mass",
                                                           "Time",
                                                           "ElectricCurrent",
                                                           "Temperature",
...
template <>
const size_t
    EnumNmToken<DimensionBaseEnum>::d_nrStrings(ARRAY_SIZE(EnumNmToken<DimensionBaseEnum>::d_strings));
//! generated from DTD
static const EnumNmToken<DimensionBaseEnum> classDimensionBaseEnum;
}  // namespace pcrxml

pcrxml::DimensionBaseEnum::DimensionBaseEnum(const QDomNode &owningElement,
...
pcrxml::DimensionBaseEnum::DimensionBaseEnum(EnumType value) : Attribute(true), d_value(value)
{
}
