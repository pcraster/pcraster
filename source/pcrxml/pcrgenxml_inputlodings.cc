...
//! ctor
pcrxml::InputLodings::InputLodings(const QDomElement &element)
    : Element(element, d_elementName), inputType(element, "inputType", true)
{
}
...
pcrxml::InputLodings::InputLodings(const InputLodings &src)
    : pcrxml::Element(src), inputType(src.inputType)
{
}
