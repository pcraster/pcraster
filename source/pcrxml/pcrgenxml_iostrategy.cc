...
namespace pcrxml
{
template <> const char *EnumNmToken<IoStrategy>::d_strings[] = {"PCRaster", "EsriGrid", "Band"};

//! generated from DTD
template <>
const size_t EnumNmToken<IoStrategy>::d_nrStrings(ARRAY_SIZE(EnumNmToken<IoStrategy>::d_strings));
//! generated from DTD
...
pcrxml::IoStrategy::IoStrategy(EnumType value) : Attribute(true), d_value(value)
{
}
