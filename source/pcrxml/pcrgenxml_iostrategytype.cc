...
namespace pcrxml
{
template <> const char *EnumNmToken<IOStrategyType>::d_strings[] = {"IOFiles", "IOMemory"};

//! generated from DTD
template <>
const size_t
    EnumNmToken<IOStrategyType>::d_nrStrings(ARRAY_SIZE(EnumNmToken<IOStrategyType>::d_strings));
//! generated from DTD
static const EnumNmToken<IOStrategyType> classIOStrategyType;
}  // namespace pcrxml

pcrxml::IOStrategyType::IOStrategyType(const QDomNode &owningElement, const std::string &nameOfAttr,
                                       bool req)
...
pcrxml::IOStrategyType::IOStrategyType(EnumType value) : Attribute(true), d_value(value)
{
}
