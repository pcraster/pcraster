...
//! ctor
pcrxml::RiverAxisFile::RiverAxisFile(const QDomElement &element)
...
//! copy ctor
pcrxml::RiverAxisFile::RiverAxisFile(const RiverAxisFile &src) : pcrxml::Element(src), value(src.value)
{
}
