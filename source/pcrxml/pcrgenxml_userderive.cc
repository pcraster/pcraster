...
namespace pcrxml
{
template <> const char *EnumNmToken<UserDerive>::d_strings[] = {"Tree", "Child", "None"};

//! generated from DTD
template <>
const size_t EnumNmToken<UserDerive>::d_nrStrings(ARRAY_SIZE(EnumNmToken<UserDerive>::d_strings));
//! generated from DTD
...
pcrxml::UserDerive::UserDerive(EnumType value) : Attribute(true), d_value(value)
{
}
