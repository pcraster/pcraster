 ...
 */
PTYPE MinPoint(PTYPE tl, /* top left */
               PTYPE tr, /* top right */
 ...
 */
PTYPE MaxPoint(PTYPE tl, /* top left */
               PTYPE tr, /* top right */
               PTYPE br, /* bottom right */
               PTYPE bl) /* bottom left */
{
 ...
 */
POINT2D *PutInPol(PTYPE tlX, /* top left x */
 ...
 */
void ModRaster(RASTER *raster,            /* read-write raster */
 ...
 */
RASTER *NewRaster(size_t nrCoverCells, /* min. nr. of non-MV cells for non-MV */
