 ...
 */
static double WeightDirectionalMean(double *totalWeight, /* write-only total of weights */
 ...
 */
static void CalcDirectionOut(MAP *out,            /* write-only output map */
 ...
 */
static void CalcScalarOut(MAP *out,            /* write-only output map */
                          size_t rOut,         /* row of pixel to calculate */
                          size_t cOut,         /* column of pixel */
                          size_t nrList,       /* length of list */
                          const DATA *list,    /* list of values & areas */
 ...
 */
static int AddCell(DATA **list,               /* read-write list of cells */
 ...
 * Returns 0 if no error occurs, 1 otherwise.
 */
int SampleCont(MAP *out,          /* write-only output map */
               MAP **in,          /* read-only list input maps */
